  ...
  return (
    <header className="font-dm-sans header bg-noise header-bg pt-12">
      ...
      <div className="text-center">
        ...
        <p className="md:w-4/5 lg:w-5/12 mx-auto text-base md:text-xl">Ear1 helps you connect directly with your favourite influencers for a small fee. What’s more? We assure you of getting a reply.</p>
      ...
      <div className="flex w-10/12 mx-auto mt-44 md:mt-48 lg:mt-40 relative">
